...
void soloader_init_all() {
    ...
    telemetry_log("BOOT", "BUILD=2026-07-25-r18 (prop-persist Jesse+choices; full skinning so attachments dont trail; L/R both IDs; touch slot-leak; anim_rate+clock MHz configurable)");
